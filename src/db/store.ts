...
// Credentials provided directly by the user
const SUPABASE_URL = 'https://dedcojwexvvtmlbdjssd.supabase.co';
const SUPABASE_ANON_KEY = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImRlZGNvandleHZ2dG1sYmRqc3NkIiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODc2NTYzNjUsImV4cCI6MjEwMzIzMjM2NX0.grG0qjelF-MkbUU0beD1vqmzw2ppkNYgD00EQ9zORSY';
