    ...
    return (
      ...
      >
        ...
        >
          ...
          <div>
            <h2 style={{ fontSize: '20px', fontWeight: 800, color: 'var(--text-primary)' }}>Vérifiez votre boîte e-mail</h2>
            <p style={{ fontSize: '13px', color: 'var(--text-secondary)', marginTop: '8px', lineHeight: '1.6' }}>
              Un lien de confirmation a été envoyé à <strong>{email}</strong>. Veuillez cliquer sur ce lien pour activer votre compte.
            </p>
          </div>
          <button 
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '8px', marginBottom: '32px' }}>
          ...
          <p style={{ fontSize: '13px', color: 'var(--text-secondary)' }}>
            {isSignUp ? 'Créez votre compte de productivité' : 'Connectez-vous à votre espace personnel'}
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          ...
          <div className="input-group">
            ...
            />
            <label className="input-label" style={{ left: '38px' }}>Mot de passe</label>
